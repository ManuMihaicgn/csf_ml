the .csv file has a list of 60 patients of which the last 10 are JAX. Since the proportion of shunts in the JAX group of 30 is way larger than ours (or literature for that matters)
